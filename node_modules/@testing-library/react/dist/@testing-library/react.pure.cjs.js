...
var satisfies = _interopDefault(require('semver/functions/satisfies'));
...
var Scheduler = globalObj.Scheduler;
...
var isModernScheduleCallbackSupported = Scheduler && satisfies(React.version, '>16.8.6', {
