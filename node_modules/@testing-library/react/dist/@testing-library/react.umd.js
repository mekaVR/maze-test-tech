(function (global, factory) {
	...
	(global = global || self, factory(global.TestingLibraryReact = {}, global.React, global.ReactDOM, global.ReactTestUtils));
	...
	*/
	...
	var debug$1 = typeof process === 'object' && process.env && undefined && /\bsemver\b/i.test(undefined) ? function () {
	  var _console;
	...
	var MAX_LENGTH$1 = constants.MAX_LENGTH,
	    MAX_SAFE_INTEGER$2 = constants.MAX_SAFE_INTEGER;
	var re$1 = re_1.re,
	    t = re_1.t;
	...
	var SemVer = /*#__PURE__*/function () {
	  function SemVer(version, options) {
	    ...
	    var m = version.trim().match(options.loose ? re$1[t.LOOSE] : re$1[t.FULL]);
	...
	var Comparator = /*#__PURE__*/function () {
	  _createClass$1(Comparator, null, [{
	    key: "ANY",
	    get: function get() {
	      return ANY;
	    }
	  ...
	  _proto.parse = function parse(comp) {
	    var r = this.options.loose ? re$2[t$1.COMPARATORLOOSE] : re$2[t$1.COMPARATOR];
	    var m = comp.match(r);
	...
	var Range = /*#__PURE__*/function () {
	  ...
	  _proto.parseRange = function parseRange(range) {
	    ...
	    var hr = loose ? re$3[t$2.HYPHENRANGELOOSE] : re$3[t$2.HYPHENRANGE];
	    range = range.replace(hr, hyphenReplace(this.options.includePrerelease));
	    debug_1('hyphen replace', range); // `> 1.2.3 < 1.2.5` => `>1.2.3 <1.2.5`

	    range = range.replace(re$3[t$2.COMPARATORTRIM], comparatorTrimReplace);
	    debug_1('comparator trim', range, re$3[t$2.COMPARATORTRIM]); // `~ 1.2.3` => `~1.2.3`

	    range = range.replace(re$3[t$2.TILDETRIM], tildeTrimReplace); // `^ 1.2.3` => `^1.2.3`

	    range = range.replace(re$3[t$2.CARETTRIM], caretTrimReplace); // normalize spaces

	    range = range.split(/\s+/).join(' '); // At this point, the range is completely trimmed and
	    // ready to be split into comparators.

	    var compRe = loose ? re$3[t$2.COMPARATORLOOSE] : re$3[t$2.COMPARATOR];
	...
	var replaceTilde = function (comp, options) {
	  var r = options.loose ? re$3[t$2.TILDELOOSE] : re$3[t$2.TILDE];
	...
	var replaceCaret = function (comp, options) {
	  ...
	  var r = options.loose ? re$3[t$2.CARETLOOSE] : re$3[t$2.CARET];
	...
	var replaceXRange = function (comp, options) {
	  comp = comp.trim();
	  var r = options.loose ? re$3[t$2.XRANGELOOSE] : re$3[t$2.XRANGE];
	...
	var replaceStars = function (comp, options) {
	  ...
	  return comp.trim().replace(re$3[t$2.STAR], '');
	};

	var replaceGTE0 = function (comp, options) {
	  debug_1('replaceGTE0', comp, options);
	  return comp.trim().replace(re$3[options.includePrerelease ? t$2.GTE0PRE : t$2.GTE0], '');
	...
	var satisfies = function (version, range$1, options) {
	  try {
	...
	var Scheduler = globalObj$1.Scheduler;
	...
	var isModernScheduleCallbackSupported = Scheduler && satisfies_1(React.version, '>16.8.6', {
	...
	if (typeof afterEach === 'function') {
	  afterEach( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
	    return regenerator.wrap(function (_context) {
	      while (1) {
	        switch (_context.prev = _context.next) {
	          case 0:
	  ...
	  // eslint-disable-next-line no-undef
	  teardown( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2() {
	    return regenerator.wrap(function (_context2) {
	      while (1) {
	        switch (_context2.prev = _context2.next) {
	          case 0:
